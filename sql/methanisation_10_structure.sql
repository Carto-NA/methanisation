...
(
    ...
    caract_maturite character varying(50),
    caract_procede_code character varying(150),
    caract_procede character varying(150),
    ...
    gis_part_effluent_elevage numeric(5,2),
	  ...
	  nrj_mode_valorisation character varying(150),
	  ...
	  date_clefs_debut_exploitation character varying(150),
    div_commentaires text,
    geom_valide  boolean DEFAULT false,
    geom geometry(Point,2154),
    CONSTRAINT m_eco_methanisation_na_geo_pkey PRIMARY KEY (id),
    CONSTRAINT m_eco_methanisation_na_geo_uniq UNIQUE (proj_num, proj_nom)
);
